...
namespace webrtc
{
  ...
  AudioProcessingImpl::AudioProcessingImpl(
      ...
      : env_(env),
        ...
        capture_(),
        capture_nonlocked_()
  // applied_input_volume_stats_reporter_(InputVolumeStatsReporter::InputVolumeType::kApplied),
  // recommended_input_volume_stats_reporter_(InputVolumeStatsReporter::InputVolumeType::kRecommended)
  {
